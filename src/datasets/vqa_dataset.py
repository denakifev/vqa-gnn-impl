"""
VQA-2 dataset interfaces for the coursework VQA-GNN extension.
...
Important status:
    VQA-2 is not a validated paper-result path in this repository. It reuses
    the VQA-GNN-style model/trainer interfaces as a coursework baseline.

Deviation from the GQA paper-aligned path:
    ...
    See README.md for preparation expectations.
"""
